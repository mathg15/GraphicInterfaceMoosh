...
def homepage():
    ...
    st.write("Coefficient de réflexion en fonction de l'angle pour une structure multicouche contenant du Chrome")
    st.image("./Images/reflexionCrTM.png")
    st.write("Faisceau lumineux dans un lame de verre SiO2")
    st.image("./Images/beam.png")
