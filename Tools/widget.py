...
class sidebarWidget:
    ...
    def posBeamGen(self):
        return st.slider("Position", 0.0, 1.0, 0.4, 0.1, key=2)
    ...
    def angCoefSPR(self):
        return st.number_input("Angle", 1.0, 90.0, 45.0, 0.1, key=10)

    def angSpecSPR(self):
        return st.number_input("Angle", 1.0, 90.0, 45.0, 0.1, key=11)

    def angBeamSPR(self):
        return st.number_input("Angle", 1.0, 90.0, 45.0, 0.1, key=12)

    def lambCoefSPR(self):
        return st.number_input("Longueur d'onde", 400, 800, 600, key=9)

    def lambAngSPR(self):
        return st.number_input("Longueur d'onde", 400, 800, 600, key=10)

    def lambBeamSPR(self):
        return st.number_input("Longueur d'onde", 400, 800, 600, key=11)
    ...
    def posBeamSPR(self):
        return st.slider("Position", 0.0, 1.0, 0.4, 0.1, key=3)

    def absLambGen(self):
        return st.number_input("Longueur d'onde", 400, 800, 600, key=12)
