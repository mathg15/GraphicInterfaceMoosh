...
class sidebarWidget:
    ...
    def angleInput1(self):
        return st.number_input("Angle d'incidence", 1, 90, 35, format=None)

    def angleInput2(self):
        return st.number_input("Angle d'incidence", 0, 90, 35, format=None)

    def angleInput3(self):
        return st.number_input("Angle d'incidence", 0, 90, 35, format=None)

    def lambdaInput1(self):
        return st.number_input("Longueur d'onde", 400, 800, 600, format=None)
    ...
    def hauteurGen1(self):
        return st.number_input("Epaisseur du matériau 1", 1, 20000, 400, 1)

    def selecBoxGen2(self):
        return st.selectbox("Choix du matériau 2", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen2(self):
        return st.number_input("Epaisseur du matériau 2", 1, 20000, 400, 1)

    def selecBoxGen3(self):
        return st.selectbox("Choix du matériau 3", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen3(self):
        return st.number_input("Epaisseur du matériau 3", 1, 20000, 400, 1)

    def selecBoxGen4(self):
        return st.selectbox("Choix du matériau 4", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen4(self):
        return st.number_input("Epaisseur du matériau 4", 1, 20000, 400, 1)

    def selecBoxGen5(self):
        return st.selectbox("Choix du matériau 5", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen5(self):
        return st.number_input("Epaisseur du matériau 5", 1, 20000, 400, 1)

    def selecBoxGen6(self):
        return st.selectbox("Choix du matériau 6", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen6(self):
        return st.number_input("Epaisseur du matériau 6", 1, 20000, 400, 1)

    def selecBoxGen7(self):
        return st.selectbox("Choix du matériau 7", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen7(self):
        return st.number_input("Epaisseur du matériau 7", 1, 20000, 400, 1)

    def selecBoxGen8(self):
        return st.selectbox("Choix du matériau 8", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen8(self):
        return st.number_input("Epaisseur du matériau 8", 1, 20000, 400, 1)

    def selecBoxGen9(self):
        return st.selectbox("Choix du matériau 9", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen9(self):
        return st.number_input("Epaisseur du matériau 9", 1, 20000, 400, 1)

    def selecBoxGen10(self):
        return st.selectbox("Choix du matériau 10", ("Air", "Eau", "Bk7", "SiO2", "TiO2", "Au", "Cr","Ag","ZnO"))

    def hauteurGen10(self):
        return st.number_input("Epaisseur du matériau 10", 1, 20000, 400, 1)
    ...
    def minWinAngGen(self):
        return st.number_input("Angle minimum", 0, 90, 0, format=None)

    def maxWinAngGen(self):
        return st.number_input("Angle maximum", 0, 90, 90, format=None)

    def lambBeamGen(self):
        return st.number_input("Longueur d'onde", 400, 800, 600)

    def angBeamGen(self):
        return st.number_input("Angle", 1.0, 90.0, 45.0, 0.1)
